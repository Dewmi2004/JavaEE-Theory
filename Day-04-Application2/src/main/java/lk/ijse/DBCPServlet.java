...
//    @Override
//    public void init() throws ServletException { //globle access for connection pool , execute when start the server
...
//    }
    ...
    BasicDataSource ds;// for globle use in this servlet
    @Override
